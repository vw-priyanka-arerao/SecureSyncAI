			...
			Object.keys(sxObject).forEach((styleKey) => {
				...
				if (value !== null && value !== void 0) {
					if (typeof value === "object") {
						if (config[styleKey]) css = merge$1(css, getThemeValue(styleKey, value, theme, config));
						else {
...
//#endregion
//#region node_modules/@mui/material/styles/createGetSelector.js
...
//#endregion
export { _extends as $, decomposeColor as A, preprocessStyles as B, purple as C, useDefaultProps as D, DefaultPropsProvider as E, hslToRgb as F, styled$1 as G, createSpacing as H, lighten as I, keyframes as J, Global as K, recomposeColor as L, getContrastRatio as M, getLuminance as N, alpha as O, hexToRgb as P, StyleSheet as Q, rgbToHex as R, red as S, common as T, createBreakpoints as U, createTheme$1 as V, internal_serializeStyles as W, ThemeContext as X, CacheProvider as Y, createCache as Z, createMixins as _, require_react_is$2 as _t, defaultTheme as a, handleBreakpoints as at, blue as b, excludeVariablesFromRoot as c, clamp as ct, getOverlayAlpha as d, resolveProps as dt, styleFunctionSx as et, createMuiTheme as f, capitalize as ft, createTypography as g, isPlainObject as gt, easing as h, deepmerge as ht, identifier_default as i, getPath as it, emphasize as j, darken as k, shouldSkipGeneratingVar as l, generateUtilityClass as lt, duration as m, require_prop_types as mt, rootShouldForwardProp as n, createUnarySpacing as nt, createTheme as o, mergeBreakpointsInOrder as ot, createTransitions as p, getDisplayName as pt, css as q, slotShouldForwardProp as r, getValue as rt, createThemeWithVars as s, resolveBreakpointValues as st, styled as t, defaultSxConfig as tt, createColorScheme as u, ClassNameGenerator as ut, green as v, grey as w, orange as x, lightBlue as y, createStyled as z };
